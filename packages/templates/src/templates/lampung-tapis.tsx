...
export function LampungTapis({ data, preview }: TemplateProps) {
  ...
  const primary = theme.primaryColor ?? "#7a1f2b";
      ...
      >
        ...
        <div className="pointer-events-none absolute inset-6 z-10" aria-hidden="true">
          <div className="absolute top-0 left-0">
            <CornerOrnament variant="tapis-lampung" color={primary} corner="top-left" />
          </div>
          <div className="absolute top-0 right-0">
            <CornerOrnament variant="tapis-lampung" color={primary} corner="top-right" />
          </div>
          <div className="absolute bottom-0 left-0">
            <CornerOrnament variant="tapis-lampung" color={primary} corner="bottom-left" />
          </div>
          <div className="absolute bottom-0 right-0">
            <CornerOrnament variant="tapis-lampung" color={primary} corner="bottom-right" />
          </div>
        </div>
        <div className="relative z-10 w-full space-y-5">
          <TapisLampungRow color={primary} />
          {guestName && (
