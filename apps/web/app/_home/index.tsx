...
const TEMPLATES = [
  ...
  },
  {
    id: "aceh-heritage",
    name: "Aceh Heritage",
    filosifi: "Pintu hati yang terbuka untuk dua insan bersatu.",
    desc: "Motif Pinto Aceh emas di atas hitam, kesan islami dan megah.",
    palette: ["#171310", "#c9a24a", "#8b2635"],
    emoji: "🕌",
  ...
  },
  {
    id: "lampung-tapis",
    name: "Lampung Tapis",
    filosifi: "Siger emas bersinar, cinta abadi terjaga.",
    desc: "Motif Tapis geometris dengan siluet Siger, palet marun dan emas.",
    palette: ["#fbf5ec", "#7a1f2b", "#c9a84c"],
    emoji: "👑",
